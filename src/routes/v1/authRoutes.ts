...
routesAuth.get('/self/sessions', isLoggedIn, joiValidateUserId, userController.getUserSessions.bind(userController));
routesAuth.delete('/self/sessions/:deviceId/remove', isLoggedIn, joiValidateUserId, userController.removeDeviceSession.bind(userController));
